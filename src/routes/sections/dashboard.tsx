...
const WorkerDetailPage = lazy(() => import('src/pages/dashboard/ez-metric/worker-detail'));
const SalaryDetailPage = lazy(() => import('src/pages/dashboard/ez-metric/salary-detail'));
