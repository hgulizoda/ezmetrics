  ...
  const loadingStyles = {
    ...
    [`& .${toasterClasses.loadingIcon}`]: {
      ...
      background: `conic-gradient(${varAlpha(theme.palette.text.primary, 0)}, ${varAlpha(
        theme.palette.text.disabledChannel,
        0.64
      )})`,
    },
  ...
  return {
    ...
    [`& .${toasterClasses.error}`]: {
      ...
      [`& .${toasterClasses.icon}`]: {
        ...
        backgroundColor: varAlpha(theme.palette.error.darkerChannel, 0.08),
      },
    },
    /*
     * Success
    ...
    [`& .${toasterClasses.success}`]: {
      ...
      [`& .${toasterClasses.icon}`]: {
        ...
        backgroundColor: varAlpha(theme.palette.success.darkerChannel, 0.08),
      },
    },
    /*
     * Warning
    ...
    [`& .${toasterClasses.warning}`]: {
      ...
      [`& .${toasterClasses.icon}`]: {
        ...
        backgroundColor: varAlpha(theme.palette.warning.darkerChannel, 0.08),
      },
    },
    /*
     * Info
    ...
    [`& .${toasterClasses.info}`]: {
      ...
      [`& .${toasterClasses.icon}`]: {
        ...
        backgroundColor: varAlpha(theme.palette.info.darkerChannel, 0.08),
      },
    },
  };
});
